    ...
    componentWillMount() {
        ...
        xhr.addEventListener("readystatechange", function () {
            if (this.readyState === 4) {
                that.setState({
                    profileInfo: JSON.parse(this.responseText).data
                });
            }
        })
                            ...
                            <div className="row1">
                                <div className="col-left">
                                    {<Avatar className={classes.bigAvatar}>
                                        <img src={this.state.profileInfo.profile_picture} alt={"logo"} />
                                    </Avatar>}
                                </div>

                                <div className="col-center">
                                    <span><div className="row-one">{this.state.profileInfo.username}</div></span>
                                    ...
                                    <div className="row-three">
                                        <span><div className={this.state.ApiFullName}>{this.state.profileInfo.full_name}</div><div className={this.state.UpdateFullname}>{this.state.full_name}</div></span>
